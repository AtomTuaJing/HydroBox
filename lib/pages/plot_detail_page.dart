                                                                ...
                                                                (context) =>
                                                                    SizedBox(
                                                                      ...
                                                                      child: StatefulBuilder(builder:
                                                                        ...
                                                                        return StreamBuilder(
                                                                            stream:
                                                                                context.read<BLEProvider>().notify1Characteristic!.onValueReceived,
                                                                            builder: (context, snapshot) {
                                                                              if (snapshot.hasData) {
                                                                                                  ...
                                                                                                  children: [
                                                                                                    ...
                                                                                                    Row(
                                                                                                      ...
                                                                                                      children: [
                                                                                                        ...
                                                                                                        GestureDetector(
                                                                                                          onTap: () async {
                                                                                                            await context.read<BLEProvider>().writeCharacteristic!.write(utf8.encode("M-1"));
                                                                                                          },
                                                                                                          child: Container(
                                                                                                            width: 51,
                                                                                                            height: 51,
                                                                                                            padding: const EdgeInsets.all(7),
                                                                                                            decoration: BoxDecoration(borderRadius: BorderRadius.circular(7), color: modalData3[0].split(" ")[0] == "M-0" ? ColorsAsset.darkGray : ColorsAsset.primary),
